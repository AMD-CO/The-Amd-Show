...
export default (() => {
	return <Theme theme={theme}>
			...
			<Stack>
				<StackItem width="75%" lg-width="100%">
					...
					<Text as="h1" font="--headline1" md-font="--headline2" margin="10px 0">
						xo The official Website of TheWeeknd.
					</Text>
				</StackItem>
			</Stack>
		...
		<Section padding="100px 0" sm-padding="40px 0" hover-background="#707B7C " background="#707B7C ">
			<Override slot="SectionContent" align-items="center" />
			<Text as="h2" font="--headline1" md-font="--headline2" margin="20px 0 0 0">
				About TheWeeknd
			</Text>
			<Text as="p" font="--lead" margin="20px 0 0 0">
				Hi! I'm a Anjan. I'm a professional singer .
			</Text>
			{" "}
		</Section>
		<Section
				...
				<StackItem width="50%" md-width="100%">
					...
					>
						...
						<Text as="p" margin="6px 0" font="--headline3">
							Opp. King's College Circle , Toronto , 66777
						</Text>
					</Box>
					<Box
						padding="0 0 0 64px"
			...
			<Stack>
				...
				<StackItem width="50%" lg-width="100%">
					...
					<Text as="h2" font="--headline2" md-font="--headline3" margin="0">
						{" "}The Team of TheWeeknd is always working hard eventually gettimg fans closer to Anjan AKA The Weeknd
					</Text>
					{"                                                                                                          "}
				</StackItem>
			</Stack>
